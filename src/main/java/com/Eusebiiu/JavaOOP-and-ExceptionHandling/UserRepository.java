...
public class UserRepository {
    ...
    public void addUser(User user) throws InvalidUserDataException {
        if (user == null) {
            throw new InvalidUserDataException("Eroare: Campul utilizator nu poate fi gol.");
        }
        ...
        if (username == null || username.length() < 3) {
            throw new InvalidUserDataException("Eroare: Username-ul trebuie să contina minim 3 caractere.");
        }
